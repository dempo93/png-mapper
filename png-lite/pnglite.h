...
extern "C"
{
    ...
    */
    ...
    /*
            ...
            This function initializes pnglite. The parameters can be used to set your own memory allocation routines
    ...
    */
    ...
    /*
            ...
            This function is used to open a png file with the internal file IO system. This function should be used
       instead of png_open if no custom read function is used.
    ...
    */
    ...
    /*
            ...
            Only one callback has to be specified. The read callback in case of PNG reading, otherwise the write
       callback.
            ...
            Reading:
            The callback will be called each time pnglite needs more data. The callback should read as much data as
       requested, or return 0. This should always be possible if the PNG is sane.	If the output-buffer is a
       null-pointer the callback should only skip ahead the specified number of elements. If the callback is a
       null-pointer the user_pointer will be treated as a file pointer (use png_open_file instead).
